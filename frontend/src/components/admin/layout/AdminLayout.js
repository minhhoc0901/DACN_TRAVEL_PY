...
const AdminLayout = () => {
  ...
  useEffect(() => {
    ...
    if (path.startsWith('/admin/users')) {
      ...
      setActivePageName('Quản lý khuyến mãi');
    } else if (path.startsWith('/admin/prices')) {
      setActivePageName('Quản lý giá tour');
    } else if (path.startsWith('/admin/departures')) {
      setActivePageName('Quản lý lịch khởi hành');
    } else if (path.startsWith('/admin/hotels')) {
      setActivePageName('Quản lý khách sạn');
    } else if (path.startsWith('/admin/bookings')) {
      setActivePageName('Quản lý đặt tour');
    } else if (path.startsWith('/admin/withdrawals')) {
      setActivePageName('Quản lý rút tiền');
    } else if (path.startsWith('/admin/refunds')) {
      setActivePageName('Quản lý hoàn tiền');
    } else {
      setActivePageName(''); 
    }
  }, [location.pathname]);
